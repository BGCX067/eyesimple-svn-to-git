/*
 * SecurityMonkey
 * (c) 2011. Mobile Monkey
 */


jQuery(document).ready(function($){
  // alternate table rows
  $("#sn-tests-help tr:odd, #security-monkey tr:odd,").addClass('alternate');
  ...
  $('#run-tests').click(function(){
    ...
    $.blockUI({ message: 'SecurityMonkey is analyzing your site.<br />Please wait, it can take a few minutes.' });
